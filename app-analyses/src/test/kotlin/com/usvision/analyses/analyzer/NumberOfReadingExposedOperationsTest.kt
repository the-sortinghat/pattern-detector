...
internal class NumberOfReadingExposedOperationsTest {
    private lateinit var underTest: NumberOfReadingExposedOperations

    @BeforeTest
    fun `create clean, new instance of NumberOfExposedOperations`() {
        underTest = NumberOfReadingExposedOperations()
    }
    ...
    @Test
    fun `it gets 1 from a microservice M with a single reading operation`() {
        // given
        val M = Microservice(name = "noop")
    ...
    @Test
    fun `it gets 1 from a CompSys S with a single reading operation microservice`() {
        // given
        val S = CompanySystem(name = "company")
        val M = Microservice(name = "noop")
        val op = RestEndpoint("GET", "/hello")
    ...
    @Test
    fun `it gets 0 from a microservice M with a single writing operation`() {
        // given
        val M = Microservice(name = "noop")
    ...
    @Test
    fun `it gets 0 from a CompSys S with a single writing operation microservice`() {
        // given
        val S = CompanySystem(name = "company")
        val M = Microservice(name = "noop")
        val op = RestEndpoint("POST", "/hello")
